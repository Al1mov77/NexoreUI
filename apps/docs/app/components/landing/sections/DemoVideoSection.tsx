...
export function DemoVideoSection() {
  ...
  return (
    <section className="py-24 px-6 border-b border-border/80 bg-muted/20 dark:bg-[#030305] relative overflow-hidden select-none transition-colors duration-300">
          ...
          >
            ...
            <div className="h-10 border-b border-border dark:border-zinc-800/80 px-4 flex items-center justify-between bg-muted/80 dark:bg-zinc-950/95 backdrop-blur-md select-none">
              ...
              <div className="flex items-center gap-2 text-xs font-mono text-muted-foreground dark:text-zinc-400 bg-background/80 dark:bg-zinc-900/80 px-3 py-1 rounded-md border border-border dark:border-zinc-800">
                ...
                <span className="font-semibold text-foreground dark:text-zinc-300">nexoreui_demo_showcase.mp4</span>
              </div>

              <div className="text-[10px] font-mono font-bold text-violet-600 dark:text-violet-400 bg-violet-500/10 px-2.5 py-0.5 rounded-full border border-violet-500/30">
                4K ULTRA HD
              </div>
            </div>
