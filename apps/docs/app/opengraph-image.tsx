...
export const alt = 'NexoreUI - Beautiful React Components';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', padding: '80px 100px', height: '100%', justifyContent: 'space-between', zIndex: 10 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <p style={{ fontSize: 36, color: '#a1a1aa', margin: 0, padding: 0, maxWidth: 800, fontWeight: 500 }}>
              Beautiful, animated, production-ready React 19 components.
            </p>
          </div>
        </div>
        ...
        <div style={{ position: 'absolute', bottom: 80, right: 100, display: 'flex', alignItems: 'center', gap: 12, zIndex: 10 }}>
          ...
          <span style={{ fontSize: 32, fontWeight: 700, color: '#fff', letterSpacing: '-0.02em' }}>Nexore</span>
        </div>
      </div>
    ),
    { ...size }
